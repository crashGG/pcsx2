...
void ps_convert_float32_32bits()
{
	...
	SV_Target1 = uint(min(exp2(32.0f) * sample_c().r, 4294967295.0f));
}
#endif
...
void ps_convert_float32_rgba8()
{
	...
	uint d = uint(min(sample_c().r * exp2(32.0f), 4294967295.0f));
...
void ps_convert_float32_float24()
{
	...
	uint d = uint(min(sample_c().r * exp2(32.0f), 4294967295.0f)) & 0xFFFFFFu;
